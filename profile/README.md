...
| [`hns-wallet-rs`](https://github.com/handshake-rs/hns-wallet-rs) | Independent Rust wallet boundary: encrypted local wallet state, Handshake Provider API, release-gated Shakedex workflows, and narrow Bitcoin/Ethereum modules. Value operations and mainnet settlement remain disabled pending adapter qualification. |
